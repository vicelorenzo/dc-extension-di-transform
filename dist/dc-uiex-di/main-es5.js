...
var DcSdkService = /** @class */ (function () {
    function DcSdkService() {
    }
    DcSdkService.prototype.getSDK = function () {
...
var AppComponent = /** @class */ (function () {
    function AppComponent(sdkService, editor, icons, sanitizer) {
    ...
    Object.defineProperty(AppComponent.prototype, "showToolbar", {
        get: function () {
...
/* harmony import */ var simplebar_angular__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! simplebar-angular */ "./node_modules/simplebar-angular/fesm5/simplebar-angular.js");
...
var DiEditModeButton = /** @class */ (function () {
    function DiEditModeButton(mode, name, sliders) {
        this.mode = mode;
        this.name = name;
        this.sliders = sliders;
    }
    DiEditModeButton.ctorParameters = function () { return [
        { type: undefined },
        { type: String },
        { type: Array }
    ]; };
    return DiEditModeButton;
}());
...
var DiFieldService = /** @class */ (function () {
    function DiFieldService(sdk) {
        var _this = this;
        this.sdk = sdk;
        ...
        var db = this.updated.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["debounce"])(function () { return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["interval"])(100); }));
        db.subscribe(function () { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
            var sdkInstance;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.sdk.getSDK()];
                    case 1:
                        sdkInstance = _a.sent();
        ...
        sdk.getSDK().then(function (sdkInstance) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
            var _a;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _a = this;
                        return [4 /*yield*/, sdkInstance.field.getValue()];
                    case 1:
                        _a.data = _b.sent();
                        this.parseData();
                        this.updateField();
    ...
    DiFieldService.prototype.loadParams = function (params) {
        if (params.customVSE) {
    ...
    DiFieldService.prototype.updateField = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    DiFieldService.prototype.getImageHost = function () {
        return this.stagingEnvironment || ((this.data && this.data.image) ? this.data.image.defaultHost : null);
    };
    DiFieldService.prototype.parseData = function () {
        if (this.data == null) {
    ...
    DiFieldService.prototype.getSliderValue = function (slider) {
        if (this.data == null) {
            return 0;
        }
        var value = this.data[slider.field];
        return (value == null) ? 0 : value;
    };
    DiFieldService.prototype.resetDefault = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var image;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.updateField()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    DiFieldService.ctorParameters = function () { return [
        { type: _api_dc_sdk_service__WEBPACK_IMPORTED_MODULE_2__["DcSdkService"] }
    ]; };
 ...
 */
var DiImageService = /** @class */ (function () {
    function DiImageService(field, http) {
        var _this = this;
        this.field = field;
        this.http = http;
        this.imageWidth = 1;
        ...
        field.fieldUpdated.subscribe(function (data) {
            _this.parseDataChange(data);
        });
    }
    DiImageService.prototype.buildImageSrc = function (image) {
        return "https://" + this.field.getImageHost() + "/i/" + image.endpoint + "/" + encodeURIComponent(image.name);
    };
    DiImageService.prototype.loadImage = function (data) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var defaultParams, _a, _b, image;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        if (!(data.image != null)) return [3 /*break*/, 6];
                        defaultParams = '';
                        _c.label = 1;
                    case 1:
                        _c.trys.push([1, 3, , 4]);
                        _a = this;
                        return [4 /*yield*/, this.http.get(this.buildImageSrc(this.field.data.image) + '.json').toPromise()];
                    case 2:
                        _a.imageMeta = (_c.sent());
                    ...
                    case 3:
                        ...
                        this.imageSizeMultiplier = [1, 1];
                        return [3 /*break*/, 4];
                    case 4: return [4 /*yield*/, this.imageUIProvider()];
                    case 5:
                        image = _c.sent();
                        image.onload = this.imageLoaded.bind(this);
                        image.onerror = function (event) {
                            _this.imageError = 'Could not load image!';
                        };
    ...
    DiImageService.prototype.imageLoaded = function (event) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var data, bound;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                ...
                if (this.poiPx == null && this.field.isPOIActive()) {
                    bound = this.cropPx || this.getRotatedBounds();
    ...
    DiImageService.prototype.rotatePoint = function (point, angle) {
        var sin = Math.sin(angle);
        var cos = Math.cos(angle);
        return [cos * point[0] + sin * point[1], cos * point[1] - sin * point[0]];
    };
    DiImageService.prototype.getRotatedBounds = function () {
        var hw = this.imageWidth / 2;
        var hh = this.imageHeight / 2;
        var angle = this.field.data.rot;
        if (angle == null) {
            angle = 0;
        }
        angle = (angle / 180) * Math.PI;
        var corner1 = this.rotatePoint([hw, hh], angle);
        var corner2 = this.rotatePoint([hw, -hh], angle);
        var newHalfWidth = Math.max(Math.abs(corner1[0]), Math.abs(corner2[0]));
        var newHalfHeight = Math.max(Math.abs(corner1[1]), Math.abs(corner2[1]));
        return [hw - newHalfWidth, hh - newHalfHeight, newHalfWidth * 2, newHalfHeight * 2];
    };
    DiImageService.prototype.parseDataChange = function (data) {
        ...
        if (this.imageReady && this.field.isPOIActive()) {
            ...
            var bounds = this.cropPx || this.getRotatedBounds();
    ...
    DiImageService.prototype.saveCrop = function () {
    ...
    DiImageService.prototype.savePOI = function (withoutSave) {
        if (this.poiPx == null) {
            return;
        }
        var data = this.field.data;
    ...
    DiImageService.ctorParameters = function () { return [
...
var DiPreviewImage = /** @class */ (function () {
    function DiPreviewImage(url, width, height, changeFunc) {
    ...
    DiPreviewImage.prototype.beginLoading = function () {
        var _this = this;
        this.image = new Image();
        this.image.onload = function () {
            _this.displayImage = _this;
            _this.changeFunc(_this);
        };
        this.image.onerror = function () {
            _this.error = 'Not available.';
            if (_this.displayImage) {
                _this.displayImage.error = 'Not available.';
            }
            _this.changeFunc(_this);
        };
    ...
    DiPreviewImage.prototype.preferred = function () {
        return (this.displayImage == null) ? this : this.displayImage;
    };
    DiPreviewImage.prototype.preferredImage = function () {
        if (this.displayImage == null && this.error) {
            return null;
        }
        return this.preferred().image;
    };
    DiPreviewImage.ctorParameters = function () { return [
        { type: String },
        { type: Number },
        { type: Number },
        { type: Function }
    ]; };
    return DiPreviewImage;
}());
...
var DiTransformationSegment = /** @class */ (function () {
    function DiTransformationSegment(name, query, fields, defaults) {
        this.name = name;
        this.query = [query];
        this.fields = fields;
        this.defaults = defaults;
    }
    DiTransformationSegment.prototype.queryString = function () {
        return this.query.join('&');
    };
    DiTransformationSegment.ctorParameters = function () { return [
        { type: String },
        { type: String },
        { type: Array },
        { type: Array }
    ]; };
    return DiTransformationSegment;
}());

var DiPreviewService = /** @class */ (function () {
    function DiPreviewService(field, image) {
        var _this = this;
        this.field = field;
        this.image = image;
        this.previews = [];
        ...
        image.imageChanged.subscribe(function (result) {
            _this.updateDiQuery();
        });
        var db = this.updated.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["debounce"])(function () { return Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["interval"])(100); }));
        db.subscribe(function () {
            _this.updateDiPreview();
        });
    }
    DiPreviewService.prototype.decimalRound = function (value, mul) {
        return Math.round(value * mul) / mul;
    };
    DiPreviewService.prototype.addSegment = function (commands, name, query, field, defaultValue) {
        var elem = commands.find(function (trans) { return trans.name === name; });
        if (elem == null) {
    ...
    DiPreviewService.prototype.updatePreviews = function (previews) {
    ...
    DiPreviewService.prototype.previewChange = function (preview) {
        this.previewLoaded.emit(preview);
    };
    DiPreviewService.prototype.updateDiQuery = function () {
        ...
        if (this.field.isCropActive()) {
            var crop = data.crop;
            var alwaysCrop = true; // prefer crop over pcrop right now
            if (alwaysCrop || (data.rot != null && data.rot !== 0)) {
                ...
                var bounds = this.image.getRotatedBounds();
                var xOff = Math.round((this.image.imageWidth / 2) - crop[0]);
                var yOff = Math.round((this.image.imageHeight / 2) - crop[1]);
                var cropPercent = [
        ...
        this.field.data.query = queryCommands.map(function (command) { return command.queryString(); }).join('&');
        this.transformationsChanged.emit(this.transformations);
        this.updated.next(true);
    };
    DiPreviewService.prototype.getCustomQueryURL = function (query) {
        var data = this.field.data;
        var image = data.image;
        if (image == null) {
            return null;
        }
        var params = ((this.image.imageParams.length > 0) ? (this.image.imageParams + '&' + query) : ('?' + query));
        return "http://" + this.field.getImageHost() + "/i/" + image.endpoint + "/" + encodeURIComponent(image.name) + params;
    };
    DiPreviewService.prototype.updateDiPreview = function () {
        var data = this.field.data;
        var bounds = this.image.getRotatedBounds();
        var image = data.image;
        if (image == null) {
        ...
        var previewSize = 141;
        var previewPoi = (data.rot != null && data.rot !== 0) || this.field.isPOIActive();
        var baseQuery = "http://" + this.field.getImageHost() + "/i/" + image.endpoint + "/" + encodeURIComponent(image.name) + "?" + data.query;
        var func = this.previewChange.bind(this);
        var previews;
        if (previewPoi) {
            previews = [];
            ...
            var crop = (this.image.cropPx == null) ? bounds : this.image.cropPx;
            var width = previewSize;
            var height = previewSize * crop[3] / crop[2];
            if (height > previewSize) {
                width /= height / previewSize;
                height /= height / previewSize;
            }
            var requestWidth = Math.round(width * bounds[2] / crop[2]);
            var requestHeight = Math.round(height * bounds[3] / crop[3]);
    ...
    DiPreviewService.ctorParameters = function () { return [
        { type: _di_field_service__WEBPACK_IMPORTED_MODULE_2__["DiFieldService"] },
...
var EditorService = /** @class */ (function () {
    function EditorService(field, sdkService, image) {
        this.field = field;
        this.sdkService = sdkService;
        this.image = image;
    ...
    EditorService.prototype.modeRequest = function (mode) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var needBackup, _a;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0:
                        needBackup = this.previewMode === PreviewMode.View;
                        _a = mode;
                        switch (_a) {
                            case 'view': return [3 /*break*/, 1];
                            case 'swap': return [3 /*break*/, 2];
                            case 'edit': return [3 /*break*/, 3];
                            case 'poi': return [3 /*break*/, 4];
                    ...
                    case 4:
                        ...
                        return [3 /*break*/, 7];
                    case 5: return [4 /*yield*/, this.field.resetDefault()];
                    case 6:
                        _b.sent();
    ...
    EditorService.prototype.backup = function () {
        // todo: better deep copy?
        this.cancelBackup = JSON.parse(JSON.stringify(this.field.data));
    };
    EditorService.prototype.cancelChanges = function () {
        var image = this.field.data.image;
        this.field.data = this.cancelBackup;
        this.field.data.image = image;
        this.field.updateField();
    };
    EditorService.prototype.switchImage = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var sdk, result, err_1;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.sdkService.getSDK()];
                    case 1:
                        sdk = _a.sent();
                        _a.label = 2;
                    case 2:
                        _a.trys.push([2, 4, , 5]);
                        return [4 /*yield*/, sdk.mediaLink.getImage()];
                    case 3:
                        result = _a.sent();
                        return [3 /*break*/, 5];
                    case 4:
                    ...
                    case 6:
                        ...
                        return [4 /*yield*/, this.field.updateField()];
                    case 7:
                        _a.sent();
    ...
    EditorService.prototype.setMode = function (mode) {
...
var TransformListComponent = /** @class */ (function () {
    function TransformListComponent(di, field) {
        this.di = di;
        this.field = field;
        this.displayedColumns = ['name', 'query', 'fields'];
    }
    TransformListComponent.prototype.ngOnInit = function () {
    };
    TransformListComponent.prototype.clearTransform = function (transformation) {
        var data = this.field.data;
    ...
    TransformListComponent.ctorParameters = function () { return [
...
var CropToolbarComponent = /** @class */ (function () {
    function CropToolbarComponent(field, image) {
        var _this = this;
        this.field = field;
        this.image = image;
    ...
    CropToolbarComponent.prototype.ngOnInit = function () {
    };
    CropToolbarComponent.prototype.readCrop = function () {
    ...
    CropToolbarComponent.prototype.updateCrop = function (sizeUpdate) {
    ...
    CropToolbarComponent.ctorParameters = function () { return [
...
var DiPreviewComponent = /** @class */ (function () {
    function DiPreviewComponent(preview) {
        var _this = this;
        this.preview = preview;
        this.preview.previewLoaded.subscribe(function (item) {
            _this.updateContainers();
        });
    }
    DiPreviewComponent.prototype.ngOnInit = function () {
    };
    DiPreviewComponent.prototype.ngAfterViewChecked = function () {
        this.updateContainers();
    };
    DiPreviewComponent.prototype.ngOnChanges = function (changes) {
        this.updateContainers();
    };
    DiPreviewComponent.prototype.updateContainers = function () {
        var previews = this.preview.previews;
        if (previews == null) {
            previews = [];
        }
        var elems = this.imageContainers.toArray();
        var _loop_1 = function (i) {
            var preview = previews[i];
            var elem = elems[i].nativeElement;
            // make sure the elem contains only the latest preview
            var img = preview.preferredImage();
            if (img === null) {
                var toRemove = Array.from(elem.children).filter(function (child) { return child.tagName === 'IMG'; });
                toRemove.forEach(function (remove) { return elem.removeChild(remove); });
    ...
    DiPreviewComponent.ctorParameters = function () { return [
        { type: src_app_editor_di_preview_service__WEBPACK_IMPORTED_MODULE_2__["DiPreviewService"] }
    ]; };
...
var EditToolbarComponent = /** @class */ (function () {
    function EditToolbarComponent(field, editor, dimage) {
        var _this = this;
        this.field = field;
        this.editor = editor;
        this.dimage = dimage;
        ...
        this.editButtons = [
            new src_app_editor_di_edit_slider__WEBPACK_IMPORTED_MODULE_3__["DiEditModeButton"](src_app_editor_editor_service__WEBPACK_IMPORTED_MODULE_4__["PreviewMode"].EditCrop, 'Crop', [
                { type: 'listItem', name: 'Focal Point', field: 'aspectLock', value: 'poi', action: function () { return _this.poiMode(); } },
        ...
        this.modeChanged();
        editor.modeChange.subscribe(function (mode) {
            _this.modeChanged();
        });
    }
    Object.defineProperty(EditToolbarComponent.prototype, "crop", {
        get: function () {
    ...
    Object.defineProperty(EditToolbarComponent.prototype, "isLoading", {
        get: function () {
    ...
    EditToolbarComponent.prototype.modeChanged = function () {
    ...
    EditToolbarComponent.prototype.ngOnInit = function () {
    };
    EditToolbarComponent.prototype.updateSliderValue = function (slider, value) {
        this.field.updateSliderValue(slider, value);
    };
    EditToolbarComponent.prototype.getSliderValue = function (slider) {
        return this.field.getSliderValue(slider);
    };
    EditToolbarComponent.prototype.exitMode = function (rollback) {
        if (rollback) {
            this.editor.cancelChanges();
        }
        this.editor.modeRequest('view');
    };
    EditToolbarComponent.prototype.setMode = function (button) {
        if (!this.modeActive(button.mode)) {
            this.editor.setMode(button.mode);
        }
        this.activeSliders = button.sliders;
    };
    EditToolbarComponent.prototype.resetTransforms = function () {
        this.field.resetDefault();
    };
    EditToolbarComponent.prototype.clearCrop = function () {
        this.field.data.crop = [0, 0, 0, 0];
        this.field.data.aspectLock = 'clear';
        this.field.updateField();
    };
    EditToolbarComponent.prototype.poiMode = function () {
        this.field.data.crop = [0, 0, 0, 0];
        this.field.data.aspectLock = 'poi';
        this.field.updateField();
        // this.editor.setMode(PreviewMode.POI);
    };
    EditToolbarComponent.prototype.showCropMenu = function () {
        this.cropMenuTrigger.openMenu();
    };
    EditToolbarComponent.prototype.modeActive = function (mode) {
        var active = this.editor.previewMode;
    ...
    EditToolbarComponent.ctorParameters = function () { return [
        { type: src_app_editor_di_field_service__WEBPACK_IMPORTED_MODULE_2__["DiFieldService"] },
...
var ImageTransformerService = /** @class */ (function () {
    function ImageTransformerService(diPreview) {
        this.diPreview = diPreview;
        this.cachedHSVImageLoaded = false;
        this.lastTransform = [];
        var db = diPreview.transformationsChanged.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["debounce"])(function () { return Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["interval"])(666); }));
        db.subscribe(this.updateCachedHSV.bind(this));
    }
    ImageTransformerService.prototype.updateCachedHSV = function (transformations) {
        var _this = this;
        var queryString = transformations.filter(function (x) { return x.name === 'HSB'; }).map(function (command) { return command.queryString(); }).join('&');
        ...
        var imgSrc = this.diPreview.getCustomQueryURL(queryString);
        ...
        cachedImage.onload = function () {
            if (cachedImage !== _this.cachedHSVImage) {
                return;
            }
            _this.cachedHSVImageLoaded = true;
            _this.drawCachedHSV();
        };
        cachedImage.src = imgSrc;
    };
    ImageTransformerService.prototype.drawCachedHSV = function () {
        var canvas = this.canvas;
        this.ctx.clearRect(0, 0, canvas.width, canvas.height);
        this.ctx.drawImage(this.cachedHSVImage, 0, 0);
    };
    ImageTransformerService.prototype.renderCanvas = function (canvas, imageElem, data, force) {
        ...
        var transform = [data.hue, data.sat, data.bri];
    ...
    ImageTransformerService.prototype.initCanvas = function (canvas) {
        this.canvas = canvas;
        this.ctx = canvas.getContext('2d');
    };
    ImageTransformerService.prototype.transformDirty = function (transform) {
    ...
    ImageTransformerService.prototype.transformNeeded = function () {
        return this.lastTransform.findIndex(function (value) { return (value !== 0 && value != null); }) !== -1;
    };
    ImageTransformerService.prototype.applyFilters = function (meta) {
        var idata = this.ctx.getImageData(0, 0, this.canvas.width, this.canvas.height);
        var data = idata.data;
        var hMod = ((meta.hue || 0) + 360) % 360;
        var sMod = 1 + (meta.sat || 0) / 100;
        var lMod = 1 + (meta.bri || 0) / 100;
    ...
    ImageTransformerService.ctorParameters = function () { return [
    ...
    return ImageTransformerService;
}());
...
var ModeButtonsComponent = /** @class */ (function () {
    function ModeButtonsComponent(field, editor) {
        var _this = this;
        this.field = field;
        this.editor = editor;
        this.updateData();
        ...
        editor.modeChange.subscribe(function (mode) {
            _this.hidden = !_this.showButtons;
        });
    }
    Object.defineProperty(ModeButtonsComponent.prototype, "showButtons", {
        get: function () {
    ...
    ModeButtonsComponent.prototype.updateData = function () {
        var data = this.field.data;
        this.hasImage = data != null && data.image != null && data.image.name !== '';
    };
    ModeButtonsComponent.prototype.ngOnInit = function () {
    };
    ModeButtonsComponent.prototype.changeMode = function (mode) {
        this.editor.modeRequest(mode);
    };
    ModeButtonsComponent.ctorParameters = function () { return [
        { type: src_app_editor_di_field_service__WEBPACK_IMPORTED_MODULE_2__["DiFieldService"] },
...
var PreviewCanvasComponent = /** @class */ (function () {
    function PreviewCanvasComponent(myElem, sanitizer, dimage, editor, field, transform) {
        var _this = this;
        this.myElem = myElem;
        this.sanitizer = sanitizer;
        this.dimage = dimage;
        ...
        this.dimage.imageChanged.subscribe(function (image) {
            _this.updateCanvasTransform();
            _this.renderCanvas(true);
        });
        editor.modeChange.subscribe(function (mode) {
            _this.updateTransformFrames(2);
        });
        editor.entered.subscribe(function (mode) {
            _this.updateTransformFrames(30);
        });
        field.fieldUpdated.subscribe(function (data) {
            _this.dataUpdated(data);
        });
        window.addEventListener('resize', function () { _this.updateCanvasTransform(); });
    }
    Object.defineProperty(PreviewCanvasComponent.prototype, "isCrop", {
        get: function () {
    ...
    Object.defineProperty(PreviewCanvasComponent.prototype, "isPreview", {
        get: function () {
    ...
    Object.defineProperty(PreviewCanvasComponent.prototype, "isPOI", {
        get: function () {
    ...
    Object.defineProperty(PreviewCanvasComponent.prototype, "isPOIActive", {
        get: function () {
    ...
    Object.defineProperty(PreviewCanvasComponent.prototype, "isLoading", {
        get: function () {
            return !this.dimage.imageReady;
        },
        enumerable: true,
    ...
    Object.defineProperty(PreviewCanvasComponent.prototype, "hasImage", {
        get: function () {
    ...
    Object.defineProperty(PreviewCanvasComponent.prototype, "imageError", {
        get: function () {
    ...
    Object.defineProperty(PreviewCanvasComponent.prototype, "imageWidth", {
        get: function () { return this.dimage.imageWidth; },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(PreviewCanvasComponent.prototype, "imageHeight", {
        get: function () { return this.dimage.imageHeight; },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(PreviewCanvasComponent.prototype, "cropPx", {
        get: function () { return this.dimage.cropPx; },
        set: function (value) { this.dimage.cropPx = value; },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(PreviewCanvasComponent.prototype, "poiPx", {
        get: function () { return this.dimage.poiPx; },
        set: function (value) { this.dimage.poiPx = value; },
        enumerable: true,
        configurable: true
    });
    PreviewCanvasComponent.prototype.getImageHost = function () {
        return this.field.getImageHost();
    };
    PreviewCanvasComponent.prototype.renderCanvas = function (force) {
        var data = this.data;
    ...
    PreviewCanvasComponent.prototype.dataUpdated = function (data) {
        this.data = data;
        this.image = (data == null) ? null : data.image;
        if (data != null) {
            this.updateTransformFrames(1);
            var isAspect = data.aspectLock != null && data.aspectLock.indexOf(':') !== -1;
            ...
            if (isAspect) {
                ...
                var split = data.aspectLock.split(':');
                if (split.length === 2) {
                    var aspect = Number(split[0]) / Number(split[1]);
    ...
    PreviewCanvasComponent.prototype.ngOnInit = function () {
        this.dimage.imageUIProvider = this.getImageElem.bind(this);
    };
    PreviewCanvasComponent.prototype.getImageElem = function () {
        var _this = this;
        ...
        return new Promise(function (resolve, reject) {
            if (_this.imageElem == null) {
                var continueFunc_1;
                continueFunc_1 = function () {
                    if (_this.imageElem == null) {
                        requestAnimationFrame(continueFunc_1);
                    }
                    else {
                        resolve(_this.imageElem.nativeElement);
                    }
                };
                requestAnimationFrame(continueFunc_1);
            }
    ...
    PreviewCanvasComponent.prototype.ngOnChanges = function (changes) {
    };
    PreviewCanvasComponent.prototype.getImageTransform = function () {
    ...
    PreviewCanvasComponent.prototype.updateTransformFrames = function (frames) {
        var _this = this;
        requestAnimationFrame(function () {
            _this.updateCanvasTransform();
            frames--;
            if (frames > 0) {
                _this.updateTransformFrames(frames);
            }
        });
    };
    PreviewCanvasComponent.prototype.updateCanvasTransform = function () {
        if (this.canvas == null) {
            return;
        }
        var container = this.canvas.nativeElement;
        // const size = [window.innerWidth - 20, 500 - 20];
        var size = [container.clientWidth - 20, container.clientHeight - 20];
        /*
        if (!this.isPreview) {
          size[0] -= 201;
          size[1] -= 42;
        ...
        */
        var bounds = this.dimage.getRotatedBounds();
        var imageSize = (this.isPreview && this.cropPx != null) ? [this.cropPx[2], this.cropPx[3]] : [bounds[2], bounds[3]];
        var transformCommands = [];
        var scale = Math.min(1, size[0] / imageSize[0], size[1] / imageSize[1]);
    ...
    PreviewCanvasComponent.prototype.getImageFilter = function () {
        var useCSS = false;
        if (useCSS) {
            var filterCommands = [];
    ...
    PreviewCanvasComponent.prototype.boundSize = function (size, bounds) {
        if (size[0] > bounds[2]) {
    ...
    PreviewCanvasComponent.prototype.forceAspect = function (aspect) {
        var bounds = this.dimage.getRotatedBounds();
        ...
        var aspectBound1 = [this.cropPx[2], this.cropPx[2] / aspect];
        var aspectBound2 = [this.cropPx[3] * aspect, this.cropPx[3]];
        if (this.dimage.imageReady) {
            this.boundSize(aspectBound1, bounds);
            this.boundSize(aspectBound2, bounds);
        }
        var newBound = [(aspectBound1[0] + aspectBound2[0]) / 2.0, (aspectBound1[1] + aspectBound2[1]) / 2.0];
    ...
    PreviewCanvasComponent.prototype.diIntensityToBrowser = function (intensity) {
        return intensity / 100 + 1;
    };
    PreviewCanvasComponent.prototype.escapeUrl = function (text) {
        return encodeURIComponent(text);
    };
    PreviewCanvasComponent.prototype.moveHandle = function (event) {
        ...
        switch (this.movingHandle) {
            ...
            case 3: // bottom left
                ...
                break;
            case 4: // move box
                var delta = (this.lastPos == null) ? [0, 0] : [localx - this.lastPos[0], localy - this.lastPos[1]];
                var allowedMove = [
                    this.cropPx[0] - bounds[0],
                    this.cropPx[1] - bounds[1],
    ...
    PreviewCanvasComponent.prototype.movePOI = function (event) {
        var pos = this.getMousePosition(event);
        var localx = pos[0];
        var localy = pos[1];
    ...
    PreviewCanvasComponent.prototype.upHandle = function (event) {
    ...
    PreviewCanvasComponent.prototype.globalOffset = function (elem) {
        if (elem.offsetParent == null) {
            return [elem.offsetLeft, elem.offsetTop];
        }
        else {
            var parent_1 = this.globalOffset(elem.offsetParent);
            return [elem.offsetLeft + parent_1[0], elem.offsetTop + parent_1[1]];
        }
    };
    PreviewCanvasComponent.prototype.getMousePosition = function (event) {
        var container = this.imageContainer.nativeElement;
        var offset = this.globalOffset(container);
        var ctrx = event.clientX - (offset[0] + this.imageWidth / 2);
        var ctry = event.clientY - (offset[1] + this.imageHeight / 2);
        var scalex = (this.data.fliph ? -1 : 1) / this.scale;
        var scaley = (this.data.flipv ? -1 : 1) / this.scale;
        var localx = ctrx * scalex + this.imageWidth / 2;
        var localy = ctry * scaley + this.imageHeight / 2;
        return [localx, localy];
    };
    PreviewCanvasComponent.prototype.clampCrop = function (clamp) {
    ...
    PreviewCanvasComponent.prototype.clampMovement = function (delta, allowed) {
    ...
    PreviewCanvasComponent.prototype.saveCrop = function () {
        this.dimage.saveCrop();
    };
    PreviewCanvasComponent.prototype.savePOI = function (withoutSave) {
        this.dimage.savePOI(withoutSave);
    };
    PreviewCanvasComponent.prototype.grabCropHandle = function (handle) {
        ...
        if (this.isCrop) {
            ...
            var moveEvent = this.moveHandle.bind(this);
    ...
    PreviewCanvasComponent.prototype.grabPOI = function () {
        if (!this.isPOI) {
            return;
        }
        var moveEvent = this.movePOI.bind(this);
        this.bindMouseEvent(moveEvent, this.upHandle.bind(this));
    };
    PreviewCanvasComponent.prototype.bindMouseEvent = function (moveEvent, upHandle) {
        var _this = this;
        var upEvent;
        var outEvent = function (event) {
            if (!(event.relatedTarget)) {
                upEvent(event);
            }
        };
        upEvent = function (event) {
            _this.myElem.nativeElement.removeEventListener('mousemove', moveEvent);
    ...
    PreviewCanvasComponent.ctorParameters = function () { return [
